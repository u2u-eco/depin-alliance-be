...
public class LeagueResource extends BaseResource {
  ...
  @POST
  @Path("")
  public ResponseData addLeague(LeagueRequest request) throws BusinessException {
  ...
  public ResponseData getUserLeague() {
    ...
    return ResponseData.ok(userLeague == null ? "" : new LeagueResponse(userLeague, user, new BigDecimal(0)));
  }
}
