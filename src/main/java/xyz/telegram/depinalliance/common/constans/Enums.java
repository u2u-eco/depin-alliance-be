...
public class Enums {
  ...
  public enum Config {
    POINT_REF(1), CPU_SLOT(2), GPU_SLOT(3), RAM_SLOT(4), STORAGE_SLOT(5), CPU_DEFAULT(6), GPU_DEFAULT(7), RAM_DEFAULT(
      ...
      13), ROOT_POINT_CLAIM(14), POINT_BUY_DEVICE(15), BONUS_REWARD_DEFAULT(16), RANDOM_PERCENT_TIMPI(17),RANDOM_PERCENT_FLASHBACK(18);
  ...
  public enum MissionType {
    TELEGRAM, TWITTER, QUIZ, ON_TIME_IN_APP, SHARE_STORY, DOWNLOAD_APP, URL, PLAY_MINI_TON, RETWEETS, TWEET_REPLIES
  }
