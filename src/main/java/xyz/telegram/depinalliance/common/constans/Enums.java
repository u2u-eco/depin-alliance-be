...
public class Enums {
  ...
  public enum MissionType {
    TELEGRAM, TWITTER, QUIZ, ON_TIME_IN_APP, SHARE_STORY, DOWNLOAD_APP, URL, PLAY_MINI_TON, RETWEETS, TWEET_REPLIES, CONNECT_X, FOLLOW_TWITTER, LIKE_TWITTER, CONNECT_OKX_WALLET_EVM
  }
